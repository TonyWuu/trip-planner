...
export const SEED_FLIGHTS: Omit<FixedItem, 'id' | 'trip_id' | 'created_at'>[] = [
  {
    type: 'flight',
    name: 'CX 805: YYZ → HKG',
    start_datetime: '2026-02-20T12:00', // Departs 11:00 PM EST on Feb 19
    end_datetime: '2026-02-21T04:00',   // Arrives 4:00 AM HKT on Feb 21 (~16h flight)
    details: {
  ...
  },
  {
    type: 'flight',
    name: 'UO 542: HKG → HAN',
    start_datetime: '2026-02-21T20:05', // Departs HKG 20:05 HKT
    end_datetime: '2026-02-21T22:10',   // Arrives HAN 21:10 Vietnam time = 22:10 HKT
    details: {
  ...
  },
  {
    type: 'flight',
    name: 'UO 543: HAN → HKG',
    start_datetime: '2026-02-27T22:55', // Departs HAN 21:55 Vietnam time = 22:55 HKT
    end_datetime: '2026-02-28T00:40',   // Arrives HKG 00:40 HKT
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-02-28T15:25',
    end_datetime: '2026-02-28T18:05',
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-03-04T13:30',
    end_datetime: '2026-03-04T16:55',
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-03-07T15:35',
    end_datetime: '2026-03-07T18:10',
    details: {
  ...
  },
  {
    type: 'flight',
    name: 'CX 828: HKG → YYZ',
    start_datetime: '2026-03-08T10:25',
    end_datetime: '2026-03-09T02:15', // Arrives 13:15 EST = 02:15 HKT next day
    details: {
  ...
  },
  {
    type: 'flight',
    name: 'KL 888: HKG → AMS',
    start_datetime: '2026-03-08T23:25',
    end_datetime: '2026-03-09T13:40', // Arrives 06:40 CET = 13:40 HKT
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-03-09T15:40', // Departs 08:40 CET = 15:40 HKT
    end_datetime: '2026-03-09T17:40',   // Arrives 10:40 CET = 17:40 HKT
    details: {
...
export const SEED_HOTELS: Omit<FixedItem, 'id' | 'trip_id' | 'created_at'>[] = [
  {
    ...
    start_datetime: '2026-02-20T15:00',
    end_datetime: '2026-02-28T11:00',
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-02-28T15:00',
    end_datetime: '2026-03-04T11:00',
    details: {
  ...
  },
  {
    ...
    start_datetime: '2026-03-04T15:00',
    end_datetime: '2026-03-07T11:00',
    details: {
  ...
  },
  {
    type: 'hotel',
    name: 'Kornhill Garden, Hong Kong',
    start_datetime: '2026-03-07T15:00',
    end_datetime: '2026-03-08T11:00',
    details: {
      address: '1 Hong On St, Kornhill, Hong Kong',
      city: 'Hong Kong',
    },
